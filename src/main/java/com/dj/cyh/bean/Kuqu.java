 ...
 * @TableName kuqu
 */
@TableName(value ="kuqu")
@Data
public class Kuqu implements Serializable {
    /**
     * 库区id
     */
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getKufangCode() == null ? other.getKufangCode() == null : this.getKufangCode().equals(other.getKufangCode()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getKufangCode() == null) ? 0 : getKufangCode().hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", kufangCode=").append(kufangCode);

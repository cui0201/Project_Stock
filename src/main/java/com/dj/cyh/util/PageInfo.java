...
public class PageInfo<T> {
    ...
    public PageInfo(Integer currentPage, Integer pageSize, Integer totalSize, List<T> dataList, Integer prevPage, Integer nextPage, Integer totalPage) {
